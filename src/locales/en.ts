const en = {
  ...
  flashFirmware: {
    ...
    backup: {
      ...
      eraseSelectedPartition: 'Erase Selected Partition',
      ...
      eraseRegion: 'Erase Flash Region',
      eraseEntireFlash: 'Erase Entire Flash',
      eraseConfirmTitle: 'Erase Entire Flash',
      eraseConfirmMessage: 'Erase the entire flash? This removes all data and cannot be undone.',
      eraseConfirmButton: 'Erase Flash',
      erasePartitionConfirmTitle: 'Erase Partition',
      erasePartitionConfirmMessage: 'Erase the selected partition ({label}) at {offset} ({size})?',
      eraseRegionConfirmTitle: 'Erase Flash Region',
      eraseRegionConfirmMessage: 'Erase {label} at {offset} for {length} bytes?',
      status: {
        connectFirst: 'Connect to a device first.',
        unsupported: 'Full flash erase is not supported by this loader.',
        partitionRequired: 'Select a partition to erase.',
        regionRequired: 'Enter an offset and length to erase.',
        regionOutOfBounds: 'Requested region exceeds detected flash size.',
        cancelled: 'Flash erase cancelled.',
        erasing: 'Erasing entire flash...',
        erasingPartition: 'Erasing partition...',
        erasingRegion: 'Erasing flash region...',
        complete: 'Flash erase complete.',
        partitionComplete: 'Partition erased.',
        regionComplete: 'Flash region erased.',
        failed: 'Erase failed: {error}',
      },
    },
    firmware: {
