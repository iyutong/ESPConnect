const zh = {
  ...
  flashFirmware: {
    ...
    backup: {
      ...
      eraseConfirmTitle: '擦除整个闪存',
      eraseConfirmMessage: '确定擦除整个闪存？这会删除所有数据且无法撤销。',
      eraseConfirmButton: '擦除闪存',
      erasePartitionConfirmTitle: '擦除分区',
      erasePartitionConfirmMessage: '确定擦除所选分区（{label}），位置 {offset}（{size}）？',
      eraseRegionConfirmTitle: '擦除闪存区域',
      eraseRegionConfirmMessage: '擦除 {label}，起始 {offset}，长度 {length} 字节？',
      status: {
        connectFirst: '请先连接设备。',
        unsupported: '此加载器不支持整片闪存擦除。',
        partitionRequired: '请选择要擦除的分区。',
        regionRequired: '请输入起始偏移和长度以擦除。',
        regionOutOfBounds: '请求区域超出检测到的闪存大小。',
        cancelled: '已取消闪存擦除。',
        erasing: '正在擦除整个闪存...',
        erasingPartition: '正在擦除分区...',
        erasingRegion: '正在擦除闪存区域...',
        complete: '闪存擦除完成。',
        partitionComplete: '分区已擦除。',
        regionComplete: '闪存区域已擦除。',
        failed: '擦除失败：{error}',
      },
    },
    firmware: {
